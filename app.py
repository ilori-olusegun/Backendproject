...
def get_info():
    ...
    Olusegun_Ilori = request.args.get('slack_name')
    Backend = request.args.get('track')
    ...
    response = {
      "slack_name": Olusegun_Ilori,
        "current_day": current_day,
        "utc_time": utc_time,
        "track": Backend,
        "github_file_url": "https://github.com/ilori-olusegun/Backendproject/blob/main/app.pys",
